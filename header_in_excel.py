def header_in_excel(worksheet, pmu):
    ...
    worksheet.cell(row=2, column=1, value='Numero')
    worksheet.cell(row=2, column=2, value='Data')
    worksheet.cell(row=2, column=3, value='Status Flags openPDC (hex)')
    worksheet.cell(row=2, column=4, value='Status Flags openPDC (binario)')
    worksheet.cell(row=2, column=5, value='Inicio (UTC)')
    worksheet.cell(row=2, column=6, value='Fim (UTC)')
    worksheet.cell(row=2, column=7, value='Periodo')